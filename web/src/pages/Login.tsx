      ...
      <section className="flex h-full flex-1 flex-col justify-around gap-8">
        ...
        <div>
          ...
          <p className="text-xl font-semibold leading-tight">
            Ajudamos pessoas e empresas a gerar a própria
            energia.
          </p>
          <p className="mt-6 leading-normal">
            Sabemos que negócios enfrentam desafios únicos e
            por isso oferecemos soluções turnkey,
            customizadas, economicamente viáveis e seguras.
            E acreditamos que as energias renováveis terão
            um lugar dominante em nossa economia pelo resto
            de nossas vidas.
          </p>
        </div>
